...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/demandes', function() { return view('admin.demandes'); })->name('admin.demandes');
    Route::get('/reclamations', function() { return view('admin.reclamations'); })->name('admin.reclamations');
...
Route::get('/test-mail',function(){
    Mail::to('test@example.com')->send(new WelcomeMail('Adam'));
    return 'E-mail enregistré dans les logs !'; 
});